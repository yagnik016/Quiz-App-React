...
const UserProfile = () => {
  ...
  return (
    ...
    <div className="text-center">
      {alert.type && alert.message && <Alert type={alert.type} message={alert.message} />}
    </div>
      ...
      <div className="profile-image">
        ...
        <input type="file" onChange={handlePhotoChange} className="form-control-file" />
      </div>
      ...
      <button onClick={handleUpdateProfile} className="btn btn-primary mt-3" style={{ marginLeft: '45%' }}>
        Update Profile
      </button>
    </div>
  );
